          ...
          <div className="board-column">
            ...
            <div className="tasks-container">
              { tasks.filter(task => task.status === 'Pending').map(task => (
                <div key={ task._id } style={ { background: task.status !== 'Completed' && new Date(task.dueDate) < new Date() ? ' linear-gradient(45deg, rgb(7, 191, 228), rgb(148, 237, 255))' : 'white' } } className="task-card">
          ...
          <div className="board-column">
            ...
            <div className="tasks-container">
              { tasks.filter(task => task.status === 'In Progress').map(task => (
                <div key={ task._id } style={ { background: task.status !== 'Completed' && new Date(task.dueDate) < new Date() ? ' linear-gradient(45deg, rgb(255, 82, 82), rgb(244, 143, 177))' : ' linear-gradient(45deg, rgb(77, 121, 255), rgb(164, 209, 255))' } } className="task-card">
                  <div className="task-header">
                    <h3 className="task-title">{ task.name }</h3>
                    <div className="task-actions">
                      <Button
